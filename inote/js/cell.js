...
(function() {
  this.Cell = function(cellNumber, themeName) {
    var toXmlString, _CPLTIME, _VER, _attachEvents, _autoFormatSelection, _call, _codemirror, _commentSelection, _compileLater, _compileTimeout, _compile_CoffeeScript, _compile_Markdown, _create, _cursorOnFirstLine, _cursorOnLastLine, _deleteCallback, _executeCode, _getNumber, _getSelectedRange, _getXml, _getXml0, _getXml1, _hideJavascriptText, _inCollapsed, _inputCell, _insertAfterCallback, _insertBeforeCallback, _jQueryCell, _javascriptCell, _javascriptTextViewer, _keyHandler, _lock, _lockButton, _mode, _n, _onfirst, _onlast, _outCollapsed, _outputCell, _print, _printError, _removeFocus, _setCursorOnFirstLine, _setCursorOnLastLine, _setFocus, _setInputCollapsed, _setMode, _setNumber, _setOutputCollapsed, _setXml, _setXml0, _setXml1, _showJavascriptText, _switchJavascriptText, _unlock;
    _n = void 0;
    _jQueryCell = void 0;
    _codemirror = void 0;
