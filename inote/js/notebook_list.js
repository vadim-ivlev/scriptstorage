...
(function() {
  var buildTable, build_delete_button, build_notebook_name_field, build_user_name_field, public_columns, user_columns;

  this.show_list = function(url, selector, store) {
    return $.ajax({
      url: url,
      success: function(d) {
