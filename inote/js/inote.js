...
(function() {
  this.iNote = function(domContainer) {
    var CELLS, appendNewCell, clear, createNewCell, deleteCell, fullScreen, getCellInfo, getIndexByCellNumber, getNewCellNumber, getTheme, getXmlText, getXmlText0, getXmlText1, globalKeyHandler, inserCellAfter, insertCellBefore, isCellFirst, isCellLast, moveFocusToNextCell, moveFocusToPreviousCell, setTheme, setXmlText, setXmlText0, setXmlText1, _VER, _container, _init, _themeName;
