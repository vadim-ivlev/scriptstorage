...
(function() {
  var adjust_ui, build_oauth_panel, delete_cookie, get_signed_network_name, hide_oauth_panel, on_page_load, on_signin, on_signout, read_cookie, write_cookie;
  ...
  build_oauth_panel = function() {
    return $("<div class='oauthHolder' style='border:1px solid silver; width:100%; min-height:10px; background-color:white; position:absolute; padding-top:10px; padding-bottom:10px; top:0px; left:0px; display:none; z-index:30000' ></div>").prependTo("body");
  };
