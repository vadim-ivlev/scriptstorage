...
(function() {
  ...
  get_random_phrase = function() {
    var i, phrases;
    phrases = ['Deep thought', 'Hello world', 'Crutial experiment', 'Great idea', 'Insight', 'Inspiration', 'Hard life', 'Genuine guess', 'Ultimate answer', 'Last attempt', 'Where is my $', 'Digital dream', 'Important', 'Meaning of life', 'Love', 'Happiness', 'Sweet dream', 'Lucky number'];
