...
js_files_text ="""
        if dbg            
            script(src='inote/libs/codemirror-3.0/lib/codemirror.js')
            script(src='inote/libs/codemirror-3.0/addon/hint/show-hint.js')
            script(src='inote/libs/codemirror-3.0/addon/hint/javascript-hint.js')
            script(src='inote/libs/codemirror-3.0/addon/comment/comment.js')
            script(src='inote/libs/codemirror-3.0/mode/xml/xml.js')
            script(src='inote/libs/codemirror-3.0/mode/javascript/javascript.js')
            script(src='inote/libs/codemirror-3.0/mode/css/css.js')
            script(src='inote/libs/codemirror-3.0/mode/htmlmixed/htmlmixed.js')
            script(src='inote/libs/codemirror-3.0/mode/coffeescript/coffeescript.js')
            script(src='inote/libs/codemirror-3.0/addon/edit/formatting.js')
            script(src='inote/libs/codemirror-3.0/addon/edit/matchbrackets.js')
            script(src='inote/libs/codemirror-3.0/addon/edit/closetag.js')
            script(src='inote/libs/codemirror-3.0/addon/fold/foldcode.js')
            script(src='inote/libs/codemirror-3.0/addon/fold/foldgutter.js')
            script(src='inote/libs/codemirror-3.0/addon/fold/brace-fold.js')
            script(src='inote/libs/codemirror-3.0/addon/fold/xml-fold.js')
            script(src='inote/libs/codemirror-3.0/addon/fold/indent-fold.js')
            script(src='inote/libs/codemirror-3.0/addon/dialog/dialog.js')
            script(src='inote/libs/codemirror-3.0/addon/search/searchcursor.js')
            script(src='inote/libs/codemirror-3.0/addon/search/search.js')
